...
; Porting defines
; ------------------------------------------------------------
PABASE_UART       EQU   0x48000000  ; PA base of UART (1MB align)
PABASE_MPU        EQU   0x48200000  ; PA base of MPU  (1MB align)
PABASE_CM         EQU   0x4A000000  ; PA base of Clock subsystem (1MB align)
PABASE_GPIO       EQU   0x4A300000  ; PA base of GPIOs (1MB align)
...
ttb_zero_loop
  ...
  LDR     r1, =PABASE_UART          ; Physical address range for Display subsystem and UART memory space
  ...
  LDR     r1, =PABASE_GPIO          ; Physical address for GPIO registers
  LSR     r1, r1, #20
  LSL     r2, r1, #2
  LSL     r1, r1, #20
  LDR     r3, =L1_DEVICE
