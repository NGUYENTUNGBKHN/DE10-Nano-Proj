/* Bare-metal fireworks example for Snowball */
...
// Distributor
#define INT_DISTRIBUTOR 0xA0411000
...
#define PROC_INTERFACE 0xA0410100
...
// Private timer
#define PRIVATE_TIMER 0xA0410600
...
// LEDs
#define GPIO128_159_BASE 0x8000E100
#define GPIO128_159_DIR (volatile unsigned int *)(GPIO128_159_BASE + 0x10)

//definitions for GPIO_0
#define LED_OFF (volatile unsigned int *)(GPIO128_159_BASE + 0x08)
#define LED_ON  (volatile unsigned int *)(GPIO128_159_BASE + 0x04)
#define LED_0 1<<14
...
void nudge_leds(void)
{
    ...
    if      (nudge == 0) { *LED_OFF = *LED_OFF | LED_0; }
    else if (nudge == 1) { *LED_ON =  *LED_ON  | LED_0;}
...
{
	//LED0 as output
	*GPIO128_159_DIR = *GPIO128_159_DIR | LED_0;
	*LED_OFF = *LED_OFF | LED_0;
	*LED_ON =  *LED_ON  | LED_0;
