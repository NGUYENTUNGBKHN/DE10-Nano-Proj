...
{
    printf("hello and goodbye from from fp_target_non_overlaid(%d)\n", arg);
}

void fp_target_0(int arg)
{
    printf("hello and goodbye from from fp_target_0(%d)\n", arg);
}

void fp_target_1(int arg)
{
    printf("hello and goodbye from from fp_target_1(%d)\n", arg);
}

void fp_target_2(int arg)
{
    printf("hello and goodbye from from fp_target_2(%d)\n", arg);
}

void fp_target_3(int arg)
{
    printf("hello and goodbye from from fp_target_3(%d)\n", arg);
}
