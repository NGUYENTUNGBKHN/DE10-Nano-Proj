; ------------------------------------------------------------
; Cortex-A17 MPCore Startup Code Example
;
...
; ------------------------------------------------------------
  ...
  IMPORT ||Image$$PERIPHERALS$$ZI$$Base||
...
; after the MMU has been enabled and scatterloading has been performed.
  ...
  ;
  ; Set peripherals base address
  ; ------------------------
  LDR    r0, =||Image$$PERIPHERALS$$ZI$$Base|| ; Base address of peripherals such as GIC
  MCR    p15, 4, r0, c15, c0, 1                ; Write address to FILASTARTR
...
ttb_zero_loop
  ...
  ; Entry for peripheral address space
  ; Needs to be marked as Device memory
  MRC     p15, 4, r1, c15, c0, 1    ; Get base address of peripheral address space
