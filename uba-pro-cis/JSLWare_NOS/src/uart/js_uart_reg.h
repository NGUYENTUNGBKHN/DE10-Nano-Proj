...
/* Tittle: UART Register														*/
/* Comment:																		*/
/*==============================================================================*/

#ifndef __J_UART_REG__
#define __J_UART_REG__


#define UART_RBR_THR_DLL   			0x0
#define UART_IER_DLH				0x4
#define UART_IIR   					0x8
#define UART_FCR   					0x8
#define UART_LCR   					0xC
