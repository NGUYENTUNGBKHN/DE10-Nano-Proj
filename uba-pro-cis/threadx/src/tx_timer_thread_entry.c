...
/*                                            in version 5.7.1            */ 
/*  08-03-2016     William E. Lamie         Modified comment(s), ensure   */ 
/*                                            timer is not accessed after */ 
/*                                            timeout unless reactivation */ 
/*                                            is necessary, set pointer   */ 
/*                                            to indicate timer being     */ 
/*                                            processed, and perform      */ 
/*                                            reactivation with           */ 
