...
/*                                            explicit value checks, added*/ 
/*                                            logic to explicitly check   */ 
/*                                            for valid pointer, fixed    */ 
/*                                            logic in consuming events,  */ 
/*                                            changed some counting       */ 
/*                                            variables to type UINT,     */ 
/*                                            merged event logging        */ 
/*                                            support, and added check    */ 
/*                                            for a NULL last satisfied   */ 
...
/*                                            compliance, resulting in    */ 
/*                                            version 5.8                 */ 
/*  02-01-2019     William E. Lamie         Modified comment(s), moved    */ 
/*                                            setup of notify callback so */ 
/*                                            that it is under interrupt  */ 
/*                                            protection and before any   */ 
/*                                            preemption, and changed     */ 
/*                                            increment of reset search   */ 
/*                                            flag to a simple set to     */ 
/*                                            true, resulting in          */ 
/*                                            version 5.9                 */ 
/*                                                                        */ 
/**************************************************************************/ 
