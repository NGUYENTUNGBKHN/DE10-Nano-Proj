...
/*  07-15-2012     William E. Lamie         Modified comment(s), added    */ 
/*                                            logic to move mapped threads*/ 
/*                                            to satisfy other threads    */ 
/*                                            with core exclusions, and   */ 
...
/*  09-01-2015     William E. Lamie         Modified comment(s), corrected*/ 
/*                                            problem scheduling thread   */ 
/*                                            on excluded core, and added */ 
/*                                            various optimizations,      */ 
/*                                            resulting in version 5.7    */ 
/*  04-01-2016     William E. Lamie         Modified comment(s), corrected*/ 
/*                                            problem with schedule thread*/ 
/*                                            not being updated in one    */ 
/*                                            optimization case, added    */ 
/*                                            setup of the preempted list */ 
/*                                            for preemption-threshold,   */ 
/*                                            and simplified code via     */ 
/*                                            in-line functions,          */ 
/*                                            resulting in version 5.7.1  */ 
/*  08-03-2016     William E. Lamie         Modified comment(s), and      */ 
/*                                            corrected the update of     */ 
/*                                            possible cores, resulting   */ 
/*                                            in version 5.7.2            */ 
