...
/*                                            preemption-threshold issue, */ 
/*                                            and utilized new cores      */ 
/*                                            allowed member in TX_THREAD,*/ 
...
/*                                            version 5.8                 */ 
/*  02-01-2019     William E. Lamie         Modified comment(s), added    */ 
/*                                            logic to evaluate mapped    */ 
/*                                            core instead of the current */ 
/*                                            core in evaluating the next */ 
/*                                            thread replacement, added   */ 
/*                                            logic to call rebalance when*/ 
/*                                            the next thread is excluded */ 
/*                                            from running on the mapped  */ 
/*                                            core, and added optimization*/ 
/*                                            when thread at the end of   */ 
/*                                            the priority list is the    */ 
/*                                            thread performing the       */ 
/*                                            relinquish, resulting in    */ 
/*                                            version 5.9                 */ 
/*                                                                        */ 
/**************************************************************************/ 
