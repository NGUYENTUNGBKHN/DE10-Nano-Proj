...
/*                                            used, and added optimization*/ 
/*                                            to avoid calling rebalance  */ 
/*                                            algorithm,                  */ 
/*                                            resulting in version 5.7    */ 
/*  04-01-2016     William E. Lamie         Modified comment(s), optimized*/ 
/*                                            processing for simple case, */ 
/*                                            and simplified code via     */ 
/*                                            in-line functions,          */ 
/*                                            resulting in version 5.7.1  */ 
/*  08-03-2016     William E. Lamie         Modified comment(s), and      */ 
/*                                            added performance           */ 
/*                                            optimization for the simple */ 
/*                                            preemption case, resulting  */ 
/*                                            in version 5.7.2            */ 
/*  06-01-2017     William E. Lamie         Modified comment(s), removed  */ 
/*                                            unnecessary code, corrected */ 
/*                                            issue with resuming a thread*/
/*                                            that was previously in the  */ 
/*                                            middle of suspending with   */ 
/*                                            an additional suspension    */ 
/*                                            request, corrected issue    */ 
