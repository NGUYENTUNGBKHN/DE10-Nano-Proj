...
/*                                            clearing of the thread      */ 
/*                                            preemption-threshold list,  */ 
/*                                            changed the name of core    */ 
/*                                            control to core excluded in */ 
/*                                            internal timer setup, and   */ 
/*                                            added setup for the new     */ 
/*                                            TX_THREAD cores excluded    */ 
/*                                            and allowed members,        */ 
...
/*                                            thread extension macro,     */ 
/*                                            added macro for setting up  */ 
/*                                            the thread timeout, and     */ 
/*                                            corrected problem restoring */ 
/*                                            preemption-threshold during */ 
/*                                            initialization, resulting   */ 
/*                                            in version 5.8              */ 
