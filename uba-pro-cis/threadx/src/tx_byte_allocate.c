...
/*                                            added processing extension, */ 
/*                                            changed logic to set return */ 
/*                                            pointer to NULL when no     */ 
/*                                            memory is available, and    */ 
/*                                            added use of alignment type */ 
/*                                            for allocating from byte    */ 
/*                                            pool, resulting in          */ 
/*                                            version 5.8                 */ 
