...
/*                                            logic to not place thread   */ 
/*                                            at head of list when        */ 
/*                                            lowering priority if the    */ 
/*                                            priority level has a thread */ 
/*                                            with preemption-threshold   */ 
/*                                            in force, and optimized     */ 
/*                                            processing, resulting in    */ 
/*                                            version 5.7.1               */ 
/*  08-03-2016     William E. Lamie         Modified comment(s), added    */ 
/*                                            logic to reverse preemption-*/ 
/*                                            threshold while the thread's*/ 
/*                                            priority is changed,        */ 
/*                                            resulting in version 5.7.2  */ 
/*  06-01-2017     William E. Lamie         Modified comment(s), removed  */ 
/*                                            unnecessary code, modified  */ 
/*                                            code for MISRA compliance,  */ 
/*                                            and added processing        */ 
/*                                            extension, resulting in     */ 
/*                                            version 5.8                 */ 
/*  02-01-2019     William E. Lamie         Modified comment(s), and      */ 
/*                                            removed update of the       */ 
/*                                            priority inheritance        */ 
/*                                            priority level, resulting   */ 
/*                                            in version 5.9              */ 
/*                                                                        */ 
/**************************************************************************/ 
