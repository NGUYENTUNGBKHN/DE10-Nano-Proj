...
/*  05-01-2014     William E. Lamie         Modified comment(s), changed  */ 
/*                                            code to eliminate a compiler*/ 
/*                                            warning, added sequence     */ 
/*                                            counters for timeouts and   */ 
/*                                            suspension, and corrected   */ 
/*                                            problem suspending the last */
/*                                            thread with preemption-     */
/*                                            threshold in force,         */ 
/*                                            resulting in version 5.6.2  */ 
/*  09-01-2015     William E. Lamie         Modified comment(s), added    */ 
/*                                            protection after the call to*/ 
/*                                            _tx_thread_system_return    */ 
/*                                            when the build option       */ 
/*                                            TX_NOT_INTERRUPTABLE is     */ 
/*                                            used, corrected problem     */ 
/*                                            scheduling thread on        */ 
/*                                            excluded core, and added    */ 
/*                                            optimization to avoid       */ 
/*                                            unnecessary priority search,*/ 
/*                                            resulting in version 5.7    */ 
/*  04-01-2016     William E. Lamie         Modified comment(s), optimized*/ 
/*                                            processing for simple case, */ 
/*                                            corrected problem disabling */ 
/*                                            preemption-threshold, and   */ 
/*                                            simplified code via in-line */ 
/*                                            functions, resulting in     */ 
/*                                            version 5.7.1               */ 
/*  08-03-2016     William E. Lamie         Modified comment(s), corrected*/ 
/*                                            the update of possible      */ 
/*                                            cores, and added performance*/ 
/*                                            optimization by determining */ 
/*                                            if nontrivial scheduling is */ 
/*                                            possible before full        */ 
/*                                            examination, resulting      */ 
/*                                            in version 5.7.2            */ 
/*  06-01-2017     William E. Lamie         Modified comment(s), corrected*/ 
/*                                            issue with self-suspending  */
/*                                            thread not at the head of   */ 
/*                                            its priority list,          */      
/*                                            modified code for MISRA     */ 
/*                                            compliance, and corrected   */ 
/*                                            problem setting up the      */ 
/*                                            trace information 4 field,  */ 
