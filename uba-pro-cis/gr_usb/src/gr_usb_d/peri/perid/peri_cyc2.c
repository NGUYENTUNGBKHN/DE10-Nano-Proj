...
#include    "dbg_mdl.h"
#define     GRCYC_DBG_TRACE2(m,n,x,y)    GRDBG_TRACE2(m,n,x,y)
#else
#define     GRCYC_DBG_TRACE2(m,n,x,y)
#endif

/************************************************************************/
/*  MACRO       : GRLIB_MAC_INC_PTR2                                    */
/*                                                                      */
...
/************************************************************************/
#define GRLIB_MAC_INC_PTR2( iPnt, iMax)  (((iPnt) + 1) % (iMax))

/************************************************************************/
/*  FUNCTION    : GRLIB_Cyclic_Init2                                    */
/*                                                                      */
...
/*  RESULT      : None                                                  */
/************************************************************************/
VOID GRLIB_Cyclic_Init2( GRLIB_CYCLIC_INFO*      ptCycInfo,
                        INT                     iNumBuff)
{
    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x01, 0, 0 );
    ...
    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x01, 0, END_FUNC );
}

/************************************************************************/
/*  FUNCTION    : GRLIB_Cyclic_CheckRead2                               */
/*                                                                      */
...
/************************************************************************/
INT GRLIB_Cyclic_CheckRead2( GRLIB_CYCLIC_INFO*      ptCycInfo)
{
    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x02, 0, 0 );

    /* check data in buffer */
    if (ptCycInfo->iReadP == ptCycInfo->iWriteP)
    {
        GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x02, 0x01, END_FUNC );
    ...
    {
        GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x02, 0x02, END_FUNC );
...
/************************************************************************/
/*  FUNCTION    : GRLIB_Cyclic_CheckWrite2                              */
/*                                                                      */
...
/************************************************************************/
INT GRLIB_Cyclic_CheckWrite2( GRLIB_CYCLIC_INFO*     ptCycInfo)
{
    INT iNextWrtPnt;

    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x03, 0, 0 );

    iNextWrtPnt = GRLIB_MAC_INC_PTR2( ptCycInfo->iWriteP, ptCycInfo->iMax);

    /* check data in buffer */
    if(iNextWrtPnt == ptCycInfo->iReadP)
    {
        GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x03, 0x01, END_FUNC );
    ...
    {
        GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x03, 0x02, END_FUNC );
...
/************************************************************************/
/*  FUNCTION    : GRLIB_Cyclic_IncRead2                                 */
/*                                                                      */
...
/*  RESULT      : None                                                  */
/************************************************************************/
VOID GRLIB_Cyclic_IncRead2( GRLIB_CYCLIC_INFO*       ptCycInfo)
{
    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x04, 0, 0 );

    /* next reading position is calculated. */
    ptCycInfo->iReadP = GRLIB_MAC_INC_PTR2( ptCycInfo->iReadP, ptCycInfo->iMax);

    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x04, 0, END_FUNC );
}

/************************************************************************/
/*  FUNCTION    : GRLIB_Cyclic_IncWrite2                                */
/*                                                                      */
...
/*  RESULT      : None                                                  */
/************************************************************************/
VOID GRLIB_Cyclic_IncWrite2( GRLIB_CYCLIC_INFO*      ptCycInfo)
{
    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x05, 0, 0 );

    /* next writing position is calculated. */
    ptCycInfo->iWriteP = GRLIB_MAC_INC_PTR2( ptCycInfo->iWriteP, ptCycInfo->iMax);

    GRCYC_DBG_TRACE2( GRDBG_PERI_CYC, 0x05, 0, END_FUNC );
}
