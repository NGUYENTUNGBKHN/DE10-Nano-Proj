...
LOCAL VOID _grp_cyclonevd_int_Out_EP( VOID );
LOCAL VOID _grp_cyclonevd_int_In_EP( VOID );
#if (GRP_CYCLONEV_FIFO_ACCESS_MODE == GRP_CYCLONEV_FIFO_PIO)
LOCAL VOID _grp_cyclonevd_int_RxFifoNonEmpty( VOID );
#endif
LOCAL VOID _grp_cyclonevd_int_GlobalOutNak( VOID );
LOCAL VOID _grp_cyclonevd_int_Resume( VOID );
LOCAL VOID _grp_cyclonevd_int_Suspend( VOID );
LOCAL VOID _grp_cyclonevd_int_Reset( VOID );
LOCAL VOID _grp_cyclonevd_int_Enum_Done( VOID );
LOCAL VOID _grp_cyclonevd_int_Session_Req( VOID );
LOCAL VOID _grp_cyclonevd_int_OTGInt( VOID );
LOCAL VOID _grp_cyclonevd_int_Sof( VOID );
LOCAL VOID _grp_cyclonevd_int_Mode_Mismatch( VOID );
LOCAL VOID _grp_cyclonevd_DisableEp( INT );



/************************************************************************************************/
/* FUNCTION   : grp_cyclonevd_Interrupt                                                         */
/*                                                                                              */
...
/*                                                                                              */
/************************************************************************************************/
VOID grp_cyclonevd_Interrupt( VOID )
{
UINT32                  ulGIntSts;
UINT32                  ulGIntMsk;
UINT32                  ulStatus;
...
/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Out_EP                                                       */
/*                                                                                              */
...
UINT32                  ulEpIntSts;
    ...
    ulDaInt    = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DAINT );         /* Read interrupt status */
    ulDaIntMsk = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DAINTMSK );      /* Read interrupt mask */
    ...
    for( iEpNo = 0; iEpNo < GRP_CYCLONEVD_EP_NUM; iEpNo++ )
    {
        if( ulDaIntSts & ( CYCLONEVD_VOUTEPINT_EP( iEpNo ) ) )
        {
            ...
            ulDoEpInt = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DOEPINT( iEpNo ) );   /* Read interrupt status */
            ulDoEpMsk = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DOEPMSK );            /* Read interrupt mask */
            ...
            if( CYCLONEVD_B01_XFERCOMPL == ( CYCLONEVD_B01_XFERCOMPL & ulEpIntSts ) )
            {
                ...
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_XFERCOMPL );
                
                if( GRUSB_DEV_EP0 == iEpNo )
                {
                    /* Endpoint 0 interrupt */
                    grp_cyclonevd_hal_CtrlOutTransactionIntr();
                }
                else
                {
                    ...
                    if( GRUSB_NULL == ptEpInfo )
                    {
                        ...
                        _grp_cyclonevd_DisableEp( iEpNo );
                    }
                    else
                    {
                        /* Endpoint x interrupt (x=1..15) */
                        grp_cyclonevd_hal_DataOutTransactionIntr( ptEpInfo );
                    }
                }
            }
            if( CYCLONEVD_B01_SETUP == ( CYCLONEVD_B01_SETUP & ulEpIntSts ) )
            {
                ...
                if( GRUSB_DEV_EP0 == iEpNo )
                {
                    ...
                    grp_cyclonevd_hal_CtrlSetupIntr();
                }
                
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_SETUPMSK );
            }
            if( CYCLONEVD_B01_NYETINTRPT == ( CYCLONEVD_B01_NYETINTRPT & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_NYETINTRPT );
            }
            if( CYCLONEVD_B01_BACK2BACKSETUP == ( CYCLONEVD_B01_BACK2BACKSETUP & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_BACK2BACKSETUP );
            }
            if( CYCLONEVD_B01_OUTTKNEPDIS == ( CYCLONEVD_B01_OUTTKNEPDIS & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_OUTTKNEPDIS );
            }
            if( CYCLONEVD_B01_AHBERR == ( CYCLONEVD_B01_AHBERR & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_AHBERR );
            }
            if( CYCLONEVD_B01_EPDISBLD == ( CYCLONEVD_B01_EPDISBLD & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DOEPINT( iEpNo ), CYCLONEVD_B01_EPDISBLD );
                ...
                else
                {
                    ...
                    grp_cyclonevd_hal_OutEndpointDisabledIntr( ptEpInfo );
                }
            }
        }
    }
...
/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_In_EP                                                        */
/*                                                                                              */
...
UINT32                  ulEpIntSts;
    ...
    for( iEpNo = 0; iEpNo < GRP_CYCLONEVD_EP_NUM; iEpNo++ )
    {
        if( ulDaIntSts & CYCLONEVD_VINEPINT_EP( iEpNo ) )
        {
            ...
            ulDiEpInt    = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DIEPINT( iEpNo ) );    /* Read interrupt status */
            ulDiEpMsk    = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DIEPMSK );             /* Read interrupt mask */
            ulDiEpEmpMsk = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_DIEPEMPMSK );          /* Read TxFIFO empty interrupt mask */
            /* Get enabled interrupt status */
            ...
            if( CYCLONEVD_B01_XFERCOMPL == ( CYCLONEVD_B01_XFERCOMPL & ulEpIntSts ) )
            {
                ...
                CYCLONEV_R32_CR( CYCLONEV_A32_OTG_DIEPEMPMSK, CYCLONEVD_VINEPTXFEMPMSK_EP( iEpNo ) );
                
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_XFERCOMPL );
                
                if( GRUSB_DEV_EP0 == iEpNo )
                {
                    /* Endpoint 0 interrupt */
                    grp_cyclonevd_hal_CtrlInTransactionIntr();
                }
                else
                {
                    /* Get endpoint information */
                    ...
                    {
                        /* Endpoint x interrupt (x=1..15) */
                        grp_cyclonevd_hal_DataInTransactionIntr( ptEpInfo );
                    }
                }
            }
            if( CYCLONEVD_B01_NAKINTRPT == ( CYCLONEVD_B01_NAKINTRPT & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_NAKMSK );
            }
            if( CYCLONEVD_B01_BBLEERR == ( CYCLONEVD_B01_BBLEERR & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_BBLEERR );
            }
            if( CYCLONEVD_B01_PKTDRPSTS == ( CYCLONEVD_B01_PKTDRPSTS & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_PKTDRPSTS );
            }
            if( CYCLONEVD_B01_BNAINTR == ( CYCLONEVD_B01_BNAINTR & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_BNAINTR );
            }
            if( CYCLONEVD_B01_TXFIFOUNDRN == ( CYCLONEVD_B01_TXFIFOUNDRN & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_TXFIFOUNDRN );
            }
            if( CYCLONEVD_B01_TXFEMP == ( CYCLONEVD_B01_TXFEMP & ulEpIntSts ) )
            {
                ...
                else
                {
                    ...
                    grp_cyclonevd_hal_TxFifoEmptyIntr( ptEpInfo );
                }
#endif
                
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_TXFEMP );
            }
            if( CYCLONEVD_B01_INEPNAKEFF == ( CYCLONEVD_B01_INEPNAKEFF & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_INEPNAKEFF );
                
                if( GRUSB_DEV_EP0 != iEpNo )
                {
                    /* IN endpoint NAK effective interrupt */
                    grp_cyclonevd_hal_InEndpointNakEffectiveIntr( iEpNo );
                }
            }
            if( CYCLONEVD_B01_INTKNTXFEMP == ( CYCLONEVD_B01_INTKNTXFEMP & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_INTKNTXFEMP );
            }
            if( CYCLONEVD_B01_TIMEOUT == ( CYCLONEVD_B01_TIMEOUT & ulEpIntSts ) )
            {
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_TIMEOUT );
            }
            if( CYCLONEVD_B01_AHBERR == ( CYCLONEVD_B01_AHBERR & ulEpIntSts ) )
            {
                /* AHB error */
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_AHBERR );
            }
            if( CYCLONEVD_B01_EPDISBLD == ( CYCLONEVD_B01_EPDISBLD & ulEpIntSts ) )
            {
                /* Endpoint disabled interrupt */
                ...
                /* Clear interrupt status */
                CYCLONEV_R32_WR( CYCLONEV_A32_OTG_DIEPINT( iEpNo ), CYCLONEVD_B01_EPDISBLD );
                ...
                else
                {
                    ...
                    grp_cyclonevd_hal_InEndpointDisabledIntr( ptEpInfo );
                }
            }
        }
    }
...
#if (GRP_CYCLONEV_FIFO_ACCESS_MODE == GRP_CYCLONEV_FIFO_PIO)
/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_RxFifoNonEmpty                                               */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_RxFifoNonEmpty( VOID )
{
    ...
    grp_cyclonevd_hal_RxFifoNonEmptyIntr();
}
#endif

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_GlobalOutNak                                                 */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_GlobalOutNak( VOID )
{
    ...
    grp_cyclonevd_hal_GlobalOutNakEffectiveIntr();
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Resume                                                       */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Resume( VOID )
{
    ...
    grp_cyclonevd_hal_ResumeIntr();
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Suspend                                                      */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Suspend( VOID )
{
    ...
    grp_cyclonevd_hal_SuspendIntr();
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Reset                                                        */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Reset( VOID )
{
    ...
    grp_cyclonevd_hal_BusResetIntr();
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Enum_Done                                                    */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Enum_Done( VOID )
{
    ...
    grp_cyclonevd_hal_EnumerationCompletion();
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Session_Req                                                  */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Session_Req( VOID )
{
    ...
    /* Interrupt clear */
    CYCLONEV_R32_WR( CYCLONEV_A32_OTG_GINTSTS, CYCLONEVG_B01_SESSREQINT );
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_OTGInt                                                       */
/*                                                                                              */
...
UINT32                  ulGOtgint;
    ...
    ulGOtgint = CYCLONEV_R32_RD( CYCLONEV_A32_OTG_GOTGINT );
    ...
    /* Interrupt clear */
    CYCLONEV_R32_WR( CYCLONEV_A32_OTG_GOTGINT, ulGOtgint );
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Sof                                                          */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Sof( VOID )
{
    ...
    /* Interrupt clear */
    CYCLONEV_R32_WR( CYCLONEV_A32_OTG_GINTSTS, CYCLONEVG_B01_SOF );
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_int_Mode_Mismatch                                                */
/*                                                                                              */
...
LOCAL VOID _grp_cyclonevd_int_Mode_Mismatch( VOID )
{
    ...
    /* Interrupt clear */
    CYCLONEV_R32_WR( CYCLONEV_A32_OTG_GINTSTS, CYCLONEVG_B01_MODEMIS );
}

/************************************************************************************************/
/* FUNCTION   : _grp_cyclonevd_DisableEp                                                        */
/*                                                                                              */
...
/*                                                                                              */
/************************************************************************************************/
LOCAL VOID _grp_cyclonevd_DisableEp( INT iEpNo )
{
GRUSB_EndPointInfo*     ptEpInfo;
