...
#include    "dbg_mdl.h"
#define GRCOMD_CNF_LOG2(m,n,x,y)  GRDBG_TRACE2(m,n,x,y)
#else
#define GRCOMD_CNF_LOG2(m,n,x,y)
...
/*                                                                          */
/****************************************************************************/
GRUSB_DEV_STRING_DESC* GRUSB_COMD_GetStrDesc2( VOID )
{
    DLOCAL union {
        struct {
...
/* <<< Sample Data <<< */
    ...
    GRCOMD_CNF_LOG2( GRDBG_COMD_CNF, 0x00, 0x00, END_FUNC );
