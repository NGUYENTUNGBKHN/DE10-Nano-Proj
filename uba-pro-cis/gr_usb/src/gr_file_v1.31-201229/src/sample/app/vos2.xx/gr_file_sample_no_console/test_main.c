...
grp_u32 g_aulGrFileBuf[FILE_POOL_SIZE/4];
...
#define _APP_TASK_NAME                  ((grp_u8 *)"tApp")
...
grp_si GRUSB_Test_Stack_Init(void)
{
    ...
    GRDBG_PRINT("<<< GRUSB_Test_Stack_Init Start >>> \r\n");
    ...
    /* GR-FILE */
    if (_usb_test_GrFileInit() != USB_TEST_OK) {
        /* error */
        return USB_TEST_NG;
    }
    /* Test application */
    if (_usb_test_AppInit() != USB_TEST_OK) {
        /* error */
        return USB_TEST_NG;
    }
    ...
    GRDBG_PRINT("<<< GRUSB_Test_Stack_Init End >>> \r\n");
