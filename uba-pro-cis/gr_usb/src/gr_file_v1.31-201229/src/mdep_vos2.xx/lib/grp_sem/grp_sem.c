...
/****************************************************************************/
/*                                                                          */
/* Copyright(C) 2003-2012 Grape Systems, Inc.,  All Rights Reserved.        */
/*                                                                          */
...
{
	if (grp_vos_CreateSemaphore(ptSem, (grp_uchar_t *)pcName, (grp_u32)iInitCnt) != 0)
	...
	grp_int32_t		iTimeout)				/* [IN]  timeout (msec) */
{
	...
	if (grp_vos_GetSemaphore(tSem, (grp_u32)uiTimeout) != 0)
