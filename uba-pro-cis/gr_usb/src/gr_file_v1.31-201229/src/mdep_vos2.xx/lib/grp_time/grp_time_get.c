...
#if 1
	tTime.sYear  = ex_rtc_clock.year;
	tTime.ucMon  = ex_rtc_clock.month;
	tTime.ucDay  = ex_rtc_clock.day;
	tTime.ucHour  = ex_rtc_clock.hour;
	tTime.ucMin  = ex_rtc_clock.minute;
	tTime.ucSec  = ex_rtc_clock.second;
#else
	tTime.sYear  = 2020;
	tTime.ucMon  = 1;
	tTime.ucDay  = 1;
