...
/*                                                                                              */
/************************************************************************************************/
#ifndef _GRP_UFI_LOCAL_H_
#define _GRP_UFI_LOCAL_H_


/**** INTERNAL DATA DEFINES *********************************************************************/
/*--- UFI Command ID ---------------------------------------------------------------------------*/
#define UFI_INQUIRY_CMD                 0x12                    /* INQUIRY                      */
#define UFI_MODE_SENSE_CMD              0x5A                    /* MODE SENSE (10) command      */
#define UFI_READ10_CMD                  0x28                    /* READ(10) command             */
#define UFI_READ12_CMD                  0xA8                    /* READ(12) command             */
#define UFI_READ_CAPACITY_CMD           0x25                    /* READ CAPACITY command        */
#define UFI_READ_FORMAT_CAPA_CMD        0x23                    /* READ FORMAT CAPA command     */
#define UFI_REQUEST_SENSE_CMD           0x03                    /* REQUEST SENSE command        */
#define UFI_TEST_UNIT_READY_CMD         0x00                    /* TEST UNIT READY command      */
#define UFI_WRITE10_CMD                 0x2A                    /* WRITE(10) command            */
#define UFI_WRITE12_CMD                 0xAA                    /* WRITE(12) command            */

/*--- UFI Command SIZE -------------------------------------------------------------------------*/
#define UFI_INQUIRY_SZ                  12
#define UFI_MODE_SENSE_SZ               12
#define UFI_READ10_SZ                   12
#define UFI_READ12_SZ                   12
#define UFI_READ_CAPACITY_SZ            12
#define UFI_READ_FORMAT_CAPA_SZ         12
#define UFI_REQUEST_SENSE_SZ            12
#define UFI_TEST_UNIT_READY_SZ          12
#define UFI_WRITE10_SZ                  12
#define UFI_WRITE12_SZ                  12

/*--- UFI Command Structure --------------------------------------------------------------------*/
/* INQUIRY Command Descriptor Block */
typedef struct  UFI_INQUIRY_STR
{
...
typedef struct  UFI_MODE_SENSE_STR
{
...
typedef struct  UFI_READ_CAPACITY_STR
{
    ...
    grp_u8                  ucControl;                              /* Control                  */
    grp_u8                  aucPadd[6];                             /* PAD                      */
} UFI_READ_CAPACITY_STR;

/* READ FORMAT CAPA Command Descriptor Block */
typedef struct  UFI_READ_FORMAT_CAPA_STR
{
    ...
    grp_u8                  ucControl;                              /* Control                  */
    grp_u8                  aucPadd[6];                             /* PAD                      */
} UFI_READ_FORMAT_CAPA_STR;

/* REQUEST SENSE Command Descriptor Block */
typedef struct  UFI_REQUEST_SENSE_STR
{
    ...
    grp_u8                  ucControl;                              /* Control                  */
    grp_u8                  aucPadd[10];                            /* PAD                      */
} UFI_REQUEST_SENSE_STR;

/* TEST UNIT READY Command Descriptor Block */
typedef struct  UFI_TEST_UNIT_READY_STR
{
    grp_u8                  ucCommand;                              /* Operation Code (00h)     */
    grp_u8                  aucReserve[4];                          /* Reserved                 */
    grp_u8                  ucControl;                              /* Control                  */
    grp_u8                  aucPadd[10];                            /* PAD                      */
} UFI_TEST_UNIT_READY_STR;

/* WRITE(10) Command Descriptor Block */
typedef struct  UFI_WRITE10_STR
{
...
typedef struct  UFI_WRITE12_STR
{
