...
; ------------------------------------------------------------
  ...
  EXPORT get_vbar_address
  ; uint32_t get_vbar_address(void);
get_vbar_address PROC
  MRC     p15, 0, r0, c12, c0, 1 ; Read Vector Base Address Register
  BX      lr
  ENDP

  EXPORT set_vbar_address
  ; void set_vbar_address(uint32_t);
set_vbar_address PROC
  MCR     p15, 0, r0, c12, c0, 1 ; Write Vector Base Address Register
  BX      lr
  ENDP
; ------------------------------------------------------------
; End of code
