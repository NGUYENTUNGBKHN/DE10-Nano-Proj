...
enum _ID003_MODE
{
	ID003_MODE_WAIT_REQ = 1,
	ID003_MODE_WAIT_DOWNLOAD_START_RSP,
	ID003_MODE_DOWNLOAD,
	ID003_MODE_DOWNLOAD_BUSY,
	ID003_MODE_DOWNLOAD_CALC_CRC,
	ID003_MODE_DOWNLOAD_COMPLETE,
	ID003_MODE_DOWNLOAD_COMPLETE_ERROR,
	ID003_MODE_DOWNLOAD_ERROR,
	ID003_MODE_DOWNLOAD_ILLEGAL_FILE_ERROR,
	ID003_MODE_DOWNLOAD_WAIT_RESET,
	ID003_MODE_QUIT
};
...
#define	ID003_FAILURE_APB_UNIT						0xA9	/* APB Unit Failure */
...
#define ID003_FAILURE_CENTERING						0xC1	/* Width brings system error for EBA-30 */
...
/*--------------------------------------------------------------*/
/*					id003 Download Result Code					*/
/*--------------------------------------------------------------*/
#define ID003_DOWNLOAD_SUCCESS					0x00
#define ID003_DOWNLOAD_FAILURE					0x80
/*--------------------------------------------------------------*/
/*					Function*/
/*--------------------------------------------------------------*/
