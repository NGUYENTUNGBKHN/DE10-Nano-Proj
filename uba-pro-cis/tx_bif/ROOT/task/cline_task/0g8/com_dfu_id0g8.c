...
#if 1//#if defined(ID0G8_BOOTIF)  /* TODO: DEBUG用 削除する */
const UB Head_iInterface_GSA[] = "1.1.2,iVIZION-200-SS,";
const u8 DucGdsBuildVersion[] = "V0.00-00,";
const u8 DucGdsManufacuturingDate[] = "2022-11-15";
const u8 DucGdsFirmwareIssue[] = "i(USA)200-SS ID0G8-01,";
...
LOCAL VOID _com_dfu_0g8_cb_ConnStat2( INT iConnStat )
{
    ...
    {
        /* 接続 */
        //2022-09-21 iset_flg(ID_USB1_CB_FLAG, EVT_USB_CON);
#if 0
...
UINT32                          ulSendSize;
    ...
    if( GRUSB_COMD_COMPLETE == iStat )
    {
        ...
        if (ulSize != 0)
        {
            ...
            {
                iset_flg(ID_USB1_CB_FLAG, EVT_USB_RCV);
...
UINT32                          ulSendSize;
    ...
    if (ulSize != 0)
    {
              ...
              //わざわざ、usb1_cb_task経由でclineタスクに通知する必要性はない、とりあえずex_dowload_data_recived_0g8でclineタスクで処理する
