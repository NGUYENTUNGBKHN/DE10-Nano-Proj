...
// DLINE
void rear_reset_usb1(void) 
{
	Gpio_out( __HAL_USB1_RESET, RESET_ASSERT );
	OSW_TSK_sleep(2);
	Gpio_out( __HAL_USB1_RESET, RESET_DEASSERT );
	OSW_TSK_sleep(20);
}
/****************************************************************************/
...
VOID _Rear_UsbConnStat( INT iConnStat )
{
	...
	iset_flg(ID_USB1_CB_FLAG, EVT_USB_CON);
}
...
VOID _Rear_UsbSendData( UINT32 ulSize, UINT8* pucData, VOID* pInfo )
{
	...
	iset_flg(ID_USB1_CB_FLAG, EVT_USB_EMP);
...
/*                                                                          */
/****************************************************************************/
s32 rear_is_usb1_connected(void)
{
	BOOLEAN bStat;
