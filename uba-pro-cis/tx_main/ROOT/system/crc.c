...
static const u16 ex_fcstab[256] = { 0x0000, 0x1189, 0x2312, 0x329b, 0x4624,
 ...
 * @param[in]	erase initialize seed value or not
 * @return 		CRC value
 **********************************************************************/
...
static const unsigned long int ex_usb_crctbl_32[256] =
{
...
u32 _calc_crc32(u32 start_adr, u32 end_adr, u32 value)
{
	...
	if(start_adr <= end_adr)
	{
	    ...
	    {
	   	    vdata = *ptr++;
        	value = (value >> 8) ^ ex_usb_crctbl_32[(u8)((value & 0xff) ^ vdata)];
			len -= 1;
    	}while(len != 0);
    }
    return(value);
